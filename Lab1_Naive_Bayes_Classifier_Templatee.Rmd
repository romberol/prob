...
naiveBayes <- setRefClass("naiveBayes",
       ...
       methods = list(
                    ...
                    {
                      message <- gsub("[[:punct:]]", "", tolower(message))
...
model <- naiveBayes()
model$fit(X, y)
b <- model$predict("In that palace there were also many galleries, and many amphitheatres where lions and men and elephants battled at the pleasure of the kings.")
